"""
Demo: head gimbal control

Copyright (c) 2025 Synria Robotics Co., Ltd.
Licensed under GPL v3.0

Features:
- Control head gimbal to specific angle
"""
...
def main(args):
    ...
    try:
        ...
        if not robot.connect():
            ...
            return
        robot.set_gimbal(x_angle=0.0, y_angle=0.0, wait_for_completion=False ,angle_format="deg")
        time.sleep(2)
        robot.set_gimbal(x_angle=5.0, y_angle=25.0, wait_for_completion=False,angle_format="deg")
        time.sleep(2)
        robot.set_gimbal(x_angle=50.0, y_angle=80.0, wait_for_completion=False,angle_format="deg")
        time.sleep(2)
